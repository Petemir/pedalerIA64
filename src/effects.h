...
extern void wah_wah_asm(float *bufferIn, float *bufferOut, float *bufferMod, unsigned long int bufferLength, int channels, float q1, float *yh, float *yb, float *yl);
