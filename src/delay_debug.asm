...
section .text
    ...
    ; dataBuffOut[i] = dataBuffEffect
    movapd xmm0, [rdx]  ; xmm0 = dataBuffEffect
    ...
    ; dataBuffOut[i] = dataBuffEffect
    movlpd xmm0, [rdx]  ; xmm0 = dataBuffEffect
    ...
    ; frame restante, procesamos un sólo double
    ; dataBuffOut[i] = dataBuffEffect
    movlpd xmm0, [rdi]  ; xmm0 = dataBuffEffect
    movlpd [rsi], xmm0  ; dataBuffOut = xmm0
